...
export default function ButtonGroups () {
  return (
    <div>
      <h2>Button groups</h2>
      <div className='btn-group btn-group-auto-size' role='group' aria-label='...'>
      ...
      <h4>Vertical</h4>
      <div className='btn-group-vertical btn-group-auto-size' role='group' aria-label='...'>
      ...
      <div className='btn-toolbar' role='toolbar' aria-label='...'>
        ...
        <div className='btn-group btn-group-auto-size' role='group' aria-label='...'>
          <div className='btn-group btn-group-auto-size' role='group'>
            <button type='button' className='btn btn-default dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
              Dropdown{' '}
              <span className='caret'></span>
            </button>
      ...
      <h4>Justified</h4>
      <div className='btn-group btn-group-justified btn-group-auto-size' role='group' aria-label='...'>
        <button type='button' className='btn btn-default'>Left</button>
        <button type='button' className='btn btn-default'>Middle</button>
        <button type='button' className='btn btn-default'>Right</button>
        <div className='btn-group btn-group-auto-size' role='group'>

  ...
  render () {
    return (
      <div>
        ...
        <button className='btn btn-default' onClick={() => this.setState({showModal2: true})}>
          Default modal
        </button>
        ...
        <button className='btn btn-default' onClick={() => this.setState({showModalSmall: true})}>
          Small modal
        </button>
        ...
        <button className='btn btn-lg btn-default' onClick={() => this.setState({showModalLarge: true})}>
          Large modal
        </button>
        ...
        <button className='btn btn-default' onClick={() => this.setState({showModalSmall2: true})}>
          Delete?
        </button>
        ...
        <button className='btn btn-default' onClick={() => this.setState({showModalSmall4: true})}>
          Set password
        </button>
        ...
        <button className='btn btn-default' onClick={() => this.setState({showModal1: true})}>
          Upgrade induction
        </button>
        ...
        <button className='btn btn-default' onClick={() => this.setState({showModal4: true})}>
          Edit account info
        </button>
